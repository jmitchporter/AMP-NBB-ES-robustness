...
#net6 <- Red
#net6_ES <- RedES
#stats_spp6 <- top_n(net_spp, 64, n)
#stats_ES6 <- top_n(net_ES, 64, n)
#net7 <- Red
#net7_ES <- RedES
#stats_spp7 <- top_n(net_spp, 152, n)
#stats_ES7 <- top_n(net_ES, 152, n)
#net8 <- Red
#net8_ES <- RedES
#stats_spp8 <- top_n(net_spp, 118, n)
#stats_ES8 <- top_n(net_ES, 118, n)
#net9 <- Red
#net9_ES <- RedES
#stats_spp9 <- top_n(net_spp, 92, n)
#stats_ES9 <- top_n(net_ES, 92, n)
#net10 <- Red
#net10_ES <- RedES
#stats_spp10 <- net_spp
#stats_ES10 <- net_ES
